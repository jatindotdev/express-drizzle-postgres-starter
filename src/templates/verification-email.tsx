...
export const VerificationEmail = ({ baseUrl, name, email, code }: VerificationEmailProps) => {
        ...
        <Body className='bg-white my-auto mx-auto font-sans'>
          <Container className='border border-solid border-[#eaeaea] rounded mt-[40px] mb-[5px] mx-auto p-[20px] w-[465px]'>
            <Section>
              ...
              <Button href={url} className='bg-black font-bold text-white px-[20px] py-[10px] rounded mt-[10px]'>
                Verify
              </Button>
            </Section>
            <Section className='flex justify-center mt-[20px]'>
              <Text className='text-gray-600'>If you did not request this email, please ignore it.</Text>
            </Section>
          </Container>
        </Body>
      </Tailwind>
