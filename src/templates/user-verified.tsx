...
export const UserVerified = ({ status, message, error }: UserVerifiedProps) => {
  ...
  return (
    <Html lang='en'>
      <Head>
        <title>{status === "verified" ? "Email verified!" : status === "invalid" ? error : "Unknown error"}</title>
        <Font
          fontFamily='DM Sans'
      ...
      <Preview>{status === "verified" ? "Email verified!" : status === "invalid" ? error : "Unknown error"}</Preview>
      <Tailwind>
        <Body className='bg-white my-auto mx-auto font-sans'>
          ...
          >
            <Section>
              <Heading>
                {status === "verified" ? "Email verified!" : status === "invalid" ? error : "Unknown error"}
              </Heading>
